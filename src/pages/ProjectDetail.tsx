    ...
    <div className="pt-32 pb-24 bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          className="mb-16"
        >
          <Link to="/projects" className="text-slate-500 hover:text-slate-900 flex items-center gap-2 mb-8 transition-colors">
            <ArrowLeft size={20} />
            Back to Portfolio
          </Link>
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
            <div>
              ...
              <div className="flex flex-wrap gap-3">
                {project.tech.map((t) => (
                  <span key={t} className="px-4 py-1.5 rounded-full bg-slate-50 border border-slate-200 text-xs font-mono text-slate-600 uppercase tracking-widest">
                    {t}
                  </span>
                ))}
              </div>
            ...
            <div className="flex gap-4">
              ...
              <a
                href={project.github}
                className="px-8 py-4 glass border-slate-200 text-slate-900 rounded-full font-bold flex items-center gap-2 hover:bg-slate-100 transition-all"
              >
                Source Code
                <Github size={20} />
              </a>
        ...
        <motion.div
          ...
          className="aspect-video rounded-[40px] overflow-hidden glass border-slate-200 p-2 mb-24"
        >
          <img
            src={project.image}
            alt={project.title}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-16 mb-24">
          <div className="lg:col-span-2 space-y-12">
            ...
            {project.caseStudy && (
              <section className="p-10 rounded-[40px] glass border-slate-200 bg-accent-magenta/5">
                ...
                <div className="space-y-8">
                  <div>
                    ...
                    <p className="text-slate-600">{project.caseStudy.challenge}</p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p className="text-slate-600">{project.caseStudy.result}</p>
                  </div>
            ...
            <section>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                {project.goals.map((goal) => (
                  <div key={goal} className="p-6 rounded-3xl glass border-slate-100 flex items-start gap-4">
          ...
          <aside className="space-y-8">
            <div className="p-8 rounded-[40px] glass border-slate-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {project.screenshots.map((s, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="rounded-3xl overflow-hidden glass border-slate-200 p-2"
              >
